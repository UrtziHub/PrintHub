...
export default function NewsSection(){
    return(
        <section className="mt-5 mx-2 md:mx-32 xl:mx-72 text-blue-950 flex flex-col">
            ...
            <div className="flex xl:flex-row flex-col gap-2 m-2 items-center">
                ...
                <div className="flex-1 m-4">
                    ...
                    <div className="flex xl:flex-row flex-col gap-2 items-start border-b border-gray-500 mt-4">
                        ...
                        <div className="flex flex-col gap-4 hover:text-indigo-800">
                            <h1 className="md:mb-5 lg:mb-7 font-bold text-xl lg:text-[26px] richtext">Fulfill every order</h1>
                            <p className="lg:mb-11 text-base md:text-lg richtext">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad! Lorem ipsum dolor sit.</p>
                        </div>
                    </div>
                    <div className="flex xl:flex-row flex-col gap-2 items-start border-b border-gray-500 mt-4">
                        ...
                        <div className="flex flex-col gap-4 hover:text-indigo-800">
                            <h1 className="md:mb-5 lg:mb-7 font-bold text-xl lg:text-[26px] richtext">Manage your money where you make it</h1>
                            <p className="lg:mb-11 text-base md:text-lg richtext">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad! Lorem ipsum dolor sit.</p>
                        </div>
                    </div>
                </div>
